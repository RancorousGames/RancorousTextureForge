...
// SYNTHETIC REPRO: 666x999 image, 128px islands at (4,5) and (140, 141)
const width = 666;
const height = 999;
const data = new Uint8Array(width * height * 4); // Clear (all 0)
...
// 2x2 grid of 128px islands
// X coords: 4-131, 140-267 (Gap 8)
// Y coords: 5-132, 141-268 (Gap 8)
drawIsland(4, 5, 128, 128);
drawIsland(140, 5, 128, 128);
drawIsland(4, 141, 128, 128);
drawIsland(140, 141, 128, 128);
